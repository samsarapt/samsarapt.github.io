...
![](http://q7l2ql4vs.bkt.clouddn.com/image-20200403105131955.png)
...
![image-20200403105906238](http://q7l2ql4vs.bkt.clouddn.com/image-20200403105906238.png)
...
![image-20200403110720093](http://q7l2ql4vs.bkt.clouddn.com/image-20200403110720093.png)
...
![image-20200403111601228](http://q7l2ql4vs.bkt.clouddn.com/image-20200403111601228.png)

## 0x02 德特茅斯

![image-20200403111906635](http://q7l2ql4vs.bkt.clouddn.com/image-20200403111906635.png)
...
![image-20200403112620044](http://q7l2ql4vs.bkt.clouddn.com/image-20200403112620044.png)
...
![image-20200403113108284](http://q7l2ql4vs.bkt.clouddn.com/image-20200403113108284.png)

### BOSS-格鲁兹之母

接下来的推荐路线是：向下，向右，向下，向右。你就来到了圣巢旅途中第一个小BOSS的底盘。当然中间你要四处逛逛街也是可以的，反正最终要来到这里就好了。

![image-20200403113456057](http://q7l2ql4vs.bkt.clouddn.com/image-20200403113456057.png)

这个小BOSS难度非常低，随便打打就可以过了。重要的是打完之后去正下方解救杂货店老板苍蝇大叔，虽然他还有个更屌的身份，这里先不说。从下图的位置进去，对话一下就可以了。

![image-20200403113821426](http://q7l2ql4vs.bkt.clouddn.com/image-20200403113821426.png)

然后我们原路返回一半。就是从上面打BOSS的那个房间为起点，向左再向上。看到一个类似于指示牌的标志，记住这个样式的路牌就代表着会有车站。

![image-20200403114231058](http://q7l2ql4vs.bkt.clouddn.com/image-20200403114231058.png)

### 车站存档

从这里上去之后就是，左边就是车站。我们先进入车站，在车站的椅子上休息一下把血补满，同时椅子也是存档的地方，如果你GG了，就会出现在上一次坐椅子的地方。坐完椅子从车站出来，向上跳三步来到下图的位置。

![image-20200403114647234](http://q7l2ql4vs.bkt.clouddn.com/image-20200403114647234.png)

### BOSS-假骑士

从右边进去，随便逛逛，砍几个小怪，你就会碰到第一个大BOSS：假骑士。

![image-20200403115047518](http://q7l2ql4vs.bkt.clouddn.com/image-20200403115047518.png)

不要看他这么大，其实也非常好打。我只提醒一点，你把像下图那样它打趴在地上**3次**就好了，3次之后它就会开始捶地板无能狂怒，然后就就会自己掉下楼死掉。

![image-20200403115329781](http://q7l2ql4vs.bkt.clouddn.com/image-20200403115329781.png)
...
![image-20200403120129991](http://q7l2ql4vs.bkt.clouddn.com/image-20200403120129991.png)
...
![image-20200403120910025](http://q7l2ql4vs.bkt.clouddn.com/image-20200403120910025.png)
...
![image-20200403121817538](http://q7l2ql4vs.bkt.clouddn.com/image-20200403121817538.png)
...
![image-20200403122141487](http://q7l2ql4vs.bkt.clouddn.com/image-20200403122141487.png)
...
![image-20200403123002007](http://q7l2ql4vs.bkt.clouddn.com/image-20200403123002007.png)

继续坐回椅子上，把灵魂捕手和蜂群集结护符装备上，打开地图，在下图标注位置，我们要进入下一张地图，苍绿之径。

![image-20200403124344384](http://q7l2ql4vs.bkt.clouddn.com/image-20200403124344384.png)

## 0x04 苍绿之径

### 寻找存档点

从上面标注的位置进来就到了苍绿之径，首先要干掉一个之前打过的盔甲怪，然后找到一把椅子休息。这个画风简直了有没有，随便一截图都是壁纸啊。![image-20200403125507030](http://q7l2ql4vs.bkt.clouddn.com/image-20200403125507030.png)
...
![image-20200403125852335](http://q7l2ql4vs.bkt.clouddn.com/image-20200403125852335.png)

左上角那个可爱的小姐姐就是我们的老婆！理论上我们从上图中站得这个位置，是跳不到老婆站得那个位置的，因为我们没有学会冲刺技能，但是这里可以有一个骚操作。首先，我们往下走1格，右边的池塘上面有一只蚊子，我们把蚊子吸引到下图这个位置来。

![image-20200403130757460](http://q7l2ql4vs.bkt.clouddn.com/image-20200403130757460.png)

然后在蚊子向我们冲来过的时候，把握时机跳到蚊子的正上方，一个下劈就可以到达对面的那个平台。讲道理这个操作有那么一丢丢难，实在不会可以放弃23333

![image-20200403131429653](http://q7l2ql4vs.bkt.clouddn.com/image-20200403131429653.png)

### 嘴强王者-左特

不管你是否成功抄了近路，你最终将来到下图这个地方。

![image-20200403132412387](http://q7l2ql4vs.bkt.clouddn.com/image-20200403132412387.png)
...
![image-20200403132928678](http://q7l2ql4vs.bkt.clouddn.com/image-20200403132928678.png)

### BOSS--大黄蜂

然后要想办法到达苍绿之径的车站，花钱开通车站，在椅子上存档，然后就出门去单挑老婆！

![image-20200403133730236](http://q7l2ql4vs.bkt.clouddn.com/image-20200403133730236.png)
...
![image-20200403135304370](http://q7l2ql4vs.bkt.clouddn.com/image-20200403135304370.png)
...
![image-20200403140042384](http://q7l2ql4vs.bkt.clouddn.com/image-20200403140042384.png)
...
![image-20200403140750321](http://q7l2ql4vs.bkt.clouddn.com/image-20200403140750321.png)
...
![image-20200403143002428](http://q7l2ql4vs.bkt.clouddn.com/image-20200403143002428.png)
...
![image-20200403144011897](http://q7l2ql4vs.bkt.clouddn.com/image-20200403144011897.png)

### 购买深巢地图

打完三螳螂之后，我们先向左边走，一直走到可以向上的时候向上。蚊子大叔在这里等我们，我们可以先找他买一张**深邃巢穴**的地图，然后就原路返回。对于现在的我们来说，深邃巢穴难度过高，不建议探索。

![image-20200403144846473](http://q7l2ql4vs.bkt.clouddn.com/image-20200403144846473.png)
...
![image-20200403150432944](http://q7l2ql4vs.bkt.clouddn.com/image-20200403150432944.png)
